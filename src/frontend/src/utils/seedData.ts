      ...
      await db.notes.bulkAdd([
        {
          ...
          content:
            "This is your personal organizer. You can create notes, track habits, manage records, and more.\n\nTips:\n• Pin important notes\n• Use labels to organize\n• Archive notes you want to keep but not see daily",
          checklistItems: [],
          imageRefs: [],
          color: "default",
          labels: ["Welcome"],
        ...
        },
        {
          ...
          title: "💡 Ideas Board",
          content:
            "Use this space to capture your ideas before they slip away!\n\n• App idea: ...\n• Book to read: ...\n• Project concept: ...",
          checklistItems: [],
          imageRefs: [],
          color: "default",
          labels: ["Ideas"],
      ...
      await db.records.bulkAdd([
        {
          ...
          content:
            "Started using MyOrganizer Pro today. Feeling motivated to build better habits!",
          createdAt: Date.now(),
          updatedAt: Date.now(),
        },
      ]);
