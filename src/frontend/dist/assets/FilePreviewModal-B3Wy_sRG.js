import { c as createLucideIcon, r as reactExports, v as useComposedRefs, j as jsxRuntimeExports, w as Primitive, x as composeEventHandlers, y as dispatchDiscreteCustomEvent, z as React, A as useLayoutEffect2, E as reactDomExports, F as createContextScope, G as useSize, H as ReactDOM, J as createCollection, K as useDirection, M as useControllableState, N as createSlot, O as composeRefs, Q as cn, D as Download, X } from "./index-DiwzXMw7.js";
/**
...
const MicOff = createLucideIcon("mic-off", __iconNode$5);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function useSpeechRecognition() {
  ...
  const shouldListenRef = reactExports.useRef(false);
  const recognitionRef = reactExports.useRef(null);
  const isRecognitionActiveRef = reactExports.useRef(false);
  reactExports.useEffect(() => {
