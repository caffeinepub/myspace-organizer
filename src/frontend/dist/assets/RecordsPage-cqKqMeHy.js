const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BJfG_i8R.js","assets/index-GhZyXB9M.css"])))=>i.map(i=>d[i]);
import { c as createLucideIcon, t as toDate, r as reactExports, d as db, s as showErrorToast, k as startOfDay, a as showSuccessToast, l as formatDateTime, R as React, j as jsxRuntimeExports, U as Upload, P as Plus, X, h as Paperclip, B as BookOpen, _ as __vitePreload, b as Trash2 } from "./index-BJfG_i8R.js";
...
import { F as FileText, a as FileType, b as FileJson, S as Search, T as Tag, c as Pin, P as Pen } from "./tag-C2uCojql.js";
/**
    ...
    setTimeout(async () => {
      try {
        const { db: db2 } = await __vitePreload(async () => {
          const { db: db3 } = await import("./index-BJfG_i8R.js").then((n) => n.S);
          return { db: db3 };
...
${r.content || ""}`).join("\n\n---\n\n");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", "data-ocid": "records.page", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-2 flex flex-wrap gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground px-1 mb-0.5", children: "From" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "date",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground px-1 mb-0.5", children: "To" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "date",
