const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CGQz-NW1.js","assets/index-DJYCW6yJ.css"])))=>i.map(i=>d[i]);
import { t as toDate, r as reactExports, d as db, s as showErrorToast, i as startOfDay, a as showSuccessToast, k as formatDateTime, R as React, j as jsxRuntimeExports, U as Upload, D as Download, P as Plus, X, I as Image$1, _ as __vitePreload } from "./index-CGQz-NW1.js";
      ...
      setTimeout(async () => {
        try {
          const { db: db2 } = await __vitePreload(async () => {
            const { db: db3 } = await import("./index-CGQz-NW1.js").then((n) => n.N);
            return { db: db3 };
