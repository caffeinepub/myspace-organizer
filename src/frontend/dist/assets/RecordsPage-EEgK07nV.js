const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-C4HmeXH6.js","assets/index-BbyltAD_.css"])))=>i.map(i=>d[i]);
import { t as toDate, r as reactExports, d as db, s as showErrorToast, i as startOfDay, a as showSuccessToast, k as formatDateTime, R as React, j as jsxRuntimeExports, U as Upload, D as Download, P as Plus, X, I as Image$1, _ as __vitePreload } from "./index-C4HmeXH6.js";
import { u as useSpeechRecognition, D as DropdownMenu, a as DropdownMenuTrigger, b as DropdownMenuContent, c as DropdownMenuLabel, d as DropdownMenuSeparator, e as DropdownMenuItem, M as MicOff, f as Mic } from "./useSpeechRecognition-BfgwItQD.js";
      ...
      setTimeout(async () => {
        try {
          const { db: db2 } = await __vitePreload(async () => {
            const { db: db3 } = await import("./index-C4HmeXH6.js").then((n) => n.N);
            return { db: db3 };
