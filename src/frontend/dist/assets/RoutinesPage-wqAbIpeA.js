import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, X, d as db, u as useRoutines, R as React, n as getTodayProfile, s as showErrorToast, L as LoadingSpinner, U as Upload, P as Plus, C as Clock, h as Pencil, b as Trash2, o as Input, I as Image, i as Paperclip, p as Button, a as showSuccessToast, f as format, q as parse } from "./index-DiwzXMw7.js";
import { u as useSpeechRecognition, F as FileDown, D as DropdownMenu, a as DropdownMenuTrigger, b as DropdownMenuContent, c as DropdownMenuLabel, d as DropdownMenuSeparator, e as DropdownMenuItem, S as Share2, M as MicOff, f as Mic, g as FilePreviewModal } from "./FilePreviewModal-B3Wy_sRG.js";
import { u as useScrollLock, C as Check, I as ImageUploadPicker } from "./ImageUploadPicker-BI8I10Wt.js";
/**
...
function RoutinesPage() {
  ...
  const [viewingItem, setViewingItem] = reactExports.useState(
    null
  );
  ...
  const handleShare = async () => {
    const items2 = allProfiles.flatMap((p) => p.items || []);
    if (!items2.length) {
      showErrorToast("No routines to share");
      return;
    }
    const text = allProfiles.map(
      (p) => `${p.profileType}
${(p.items || []).map((r) => `- ${r.time} ${r.title}`).join("\n")}`
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 max-w-lg mx-auto", children: [
    ...
    viewingItem && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "fixed inset-0 z-50 flex items-end md:items-center justify-center",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              onKeyDown: (e) => e.key === "Escape" && setViewingItem(null),
              "aria-hidden": "true"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "relative z-10 w-full max-w-4xl mx-4 bg-card rounded-t-2xl md:rounded-2xl shadow-2xl flex flex-col overflow-hidden",
              style: { maxHeight: "95vh" },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-5 py-4 border-b border-border shrink-0 bg-card", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
                    viewingItem.icon && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", children: viewingItem.icon }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold truncate", children: viewingItem.title })
                  ] }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto px-5 py-4 space-y-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 text-sm text-muted-foreground", children: [
                      ...
                      formatTime(viewingItem.time)
                    ] }),
                    viewingItem.duration && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-muted-foreground", children: [
                      viewingItem.duration,
                      " min"
                    ] }),
                    viewingItem.tag && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2.5 py-0.5 rounded-full bg-primary/10 text-primary text-xs font-medium", children: viewingItem.tag }),
                    viewingItem.completed && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "px-2.5 py-0.5 rounded-full bg-green-500/10 text-green-600 text-xs font-medium flex items-center gap-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-3 h-3" }),
                      " Completed"
                    ] })
                  ] }),
                  viewingItem.imageId && getRoutineImage(viewingItem.imageId) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full overflow-hidden rounded-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                      src: getRoutineImage(viewingItem.imageId),
                  ...
                  (() => {
                    const itemAttachments = loadRoutineAttachments(viewingItem.id);
                    if (!itemAttachments.length) return null;
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-muted-foreground mb-2", children: "Attachments" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: itemAttachments.map((af) => {
                        const displayFile = {
                          key: af.key,
                          name: af.name,
                          mimeType: af.mimeType,
                        ...
                        return /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                            ...
                            ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 px-3 py-2 text-xs text-muted-foreground", children: [
                              isVid ? "🎬" : af.mimeType === "application/pdf" ? "📄" : "📎",
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate max-w-[100px]", children: af.name })
                            ] })
                          },
                          af.key
                        );
