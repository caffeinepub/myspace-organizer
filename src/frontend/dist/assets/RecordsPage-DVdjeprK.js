const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-emf78c2L.js","assets/index-D1zl92yZ.css"])))=>i.map(i=>d[i]);
import { c as createLucideIcon, t as toDate, r as reactExports, d as db, s as showErrorToast, i as startOfDay, a as showSuccessToast, k as formatDateTime, R as React, j as jsxRuntimeExports, U as Upload, P as Plus, X, B as BookOpen, _ as __vitePreload, b as Trash2 } from "./index-emf78c2L.js";
...
import { F as FileText, a as FileType, b as FileJson, S as Search, T as Tag, c as Pin, P as Pen } from "./tag-sEeFqL1c.js";
/**
    ...
    setTimeout(async () => {
      try {
        const { db: db2 } = await __vitePreload(async () => {
          const { db: db3 } = await import("./index-emf78c2L.js").then((n) => n.O);
          return { db: db3 };
