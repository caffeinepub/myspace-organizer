const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DhrGOo5c.js","assets/index-BONmgA0b.css"])))=>i.map(i=>d[i]);
import { c as createLucideIcon, t as toDate, r as reactExports, d as db, s as showErrorToast, l as startOfDay, a as showSuccessToast, m as formatDateTime, R as React, j as jsxRuntimeExports, U as Upload, P as Plus, X, i as Paperclip, B as BookOpen, _ as __vitePreload, b as Trash2 } from "./index-DhrGOo5c.js";
...
import { F as FileText, a as FileType, b as FileJson, S as Search, T as Tag, c as Pin, P as Pen } from "./tag-BsAjRvmp.js";
/**
    ...
    setTimeout(async () => {
      try {
        const { db: db2 } = await __vitePreload(async () => {
          const { db: db3 } = await import("./index-DhrGOo5c.js").then((n) => n.W);
          return { db: db3 };
