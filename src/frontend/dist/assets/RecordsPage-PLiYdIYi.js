const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BIfhKlwb.js","assets/index-C7b7i1gW.css"])))=>i.map(i=>d[i]);
import { c as createLucideIcon, t as toDate, r as reactExports, d as db, s as showErrorToast, k as startOfDay, a as showSuccessToast, l as formatDateTime, R as React, j as jsxRuntimeExports, U as Upload, P as Plus, X, h as Paperclip, B as BookOpen, _ as __vitePreload, b as Trash2 } from "./index-BIfhKlwb.js";
...
import { F as FileText, a as FileType, b as FileJson, S as Search, T as Tag, c as Pin, P as Pen } from "./tag-BVSZyGSl.js";
/**
    ...
    setTimeout(async () => {
      try {
        const { db: db2 } = await __vitePreload(async () => {
          const { db: db3 } = await import("./index-BIfhKlwb.js").then((n) => n.S);
          return { db: db3 };
